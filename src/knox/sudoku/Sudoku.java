...
/**
 * 
 * This is the MODEL class. This class knows all about the underlying state of
 * the Sudoku game. We can VIEW the data stored in this class in a variety of
 * ways, for example, using a simple toString() method, or using a more complex
 * GUI (Graphical User Interface) such as the SudokuGUI class that is included.
 * 
 * @author jaimespacco
 *
 */
public class Sudoku {
	...
	/**
	 * 
	 * _ _ _ 3 _ 4 _ 8 9 1 _ 3 2 _ _ _ _ _ etc
	 * 
	 * 
	 * 0 0 0 3 0 4 0 8 9
	 * 
